            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Demandeur</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Demande</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Competences</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Formation</a></li>
                            <li><i class="fa fa-share-square-o"></i><a href="ui-social-buttons.html">Réalisation</a></li>
                        </ul>
                    </li>

                    <h3 class="menu-title">Emplois</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Emplois</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Emplois</a></li>
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Employeur</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Offre</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Offre Demande</a></li>
                        </ul>
                    </li>  
                </ul>
            </div><!-- /.navbar-collapse -->
